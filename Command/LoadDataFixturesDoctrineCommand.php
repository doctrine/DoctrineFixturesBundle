...
class LoadDataFixturesDoctrineCommand extends DoctrineCommand
{
    protected function configure()
    {
        $this
            ...
            ->addOption('force', null, InputOption::VALUE_NONE, 'Purges data without asking for confirmation.')
            ->setHelp(<<<EOT
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        if ($input->isInteractive() && !($input->getOption('append') || $input->getOption('force'))) {
